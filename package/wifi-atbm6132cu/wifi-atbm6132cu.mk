...
WIFI_ATBM6132CU_VERSION = 315dd4d2908a272067dd5ff221d8c2b33d21f33a
...
WIFI_ATBM6132CU_VERSION = 04b41d38b712f7b655072c349ab014737b45adef
else
WIFI_ATBM6132CU_SITE = https://github.com/gtxaspec/atbm-wifi
WIFI_ATBM6132CU_SITE_BRANCH = master
WIFI_ATBM6132CU_VERSION = 88454ec7f78fdf8ce69b1cfb7f2288251eb0bf82
endif
...
define WIFI_ATBM6132CU_LINUX_CONFIG_FIXUPS
	...
	# Fix: Comment out the assignment and uncomment the disable option
	$(call KCONFIG_SET_OPT,CONFIG_CFG80211,y)
	# $(call KCONFIG_DISABLE_OPT,CONFIG_CFG80211)
	
	# Fix: Completely disable mac80211 and its minstrel components
...
define WIFI_ATBM6132CU_COPY_CONFIG
	$(INSTALL) -D -m 0644 $(@D)/configs/atbm6132cu.config \
		$(@D)/.config
endef
